var App = function () {
	...
	var handleClassDataTables = function () {
		$('.datatable').each(function(){
			var datatable = $(this);
			// SEARCH - Add the placeholder for Search and Turn this into in-line form control
			var search_input = datatable.closest('.dataTables_wrapper').find('div[id$=_filter] input');
        ...
        init: function () {
			...
			if (App.isPage("mom")) {
				...
				oTable = $("#momTable").dataTable({bSort: true,                                     
			        ...
			        "sAjaxSource": urlData,
			        "aoColumns": [{"sClass": "TAC"},{"sClass": "TAC"},{"sClass": "TAL"},{"sClass": "TAL"},{"sClass": "TAC"},{"sClass": "TAC"},
			                      {"sClass": "TAC"},{"sClass": "TAC"}]
			    });
				$('.datatable').each(function(){
					var datatable = $(this);
					// SEARCH - Add the placeholder for Search and Turn this into in-line form control
				...
				$("#wForm").dialog({ autoOpen: false, modal: true, width: 500, maxHeight: 500,autoPositionUpdate:true,
				    //position: { my: "center top", at: "center top", of: button },
					show: {effect: "blind", duration: 1000},
				    hide: {effect: "explode", duration: 1000},
			        buttons: {                            
			            "Submit": function() {
							$("#finput").validationEngine('attach',{promptPosition : "topLeft"});
			...
			if (App.isPage("project_detail")) {
				$("#empid").select2({
					placeholder: "Select Employee"
				});
				//$("#empid").select2("val", ["130","9"]);
			}
			...
			handleClassDataTables();	//Function to format class .datatable
        },
