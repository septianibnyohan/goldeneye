...
$q = "select * from legal_typedocument where idtypedoc = '".$_REQUEST['idtypedoc']."' ";
$q1 = mysqli_query($db->dbh,$q);
$hasil2 = mysqli_fetch_array($q1);
$description = $hasil2['description'];
...
$q = "select akseslegal from employee where EmpId='".$_SESSION['userid']."' ";
				...
				{
//print_array($access);
 echo '<script language="javascript">window.location.assign("'.$__CFG_http_apps.'index.php/access/denied");</script>';
				}
...
<div class="row">
							<div class="col-md-12">
								...
								<div class="box border inverse" id="formWizard">
									...
									<div class="box-body form">
											...
											<form id="finput"  name="forminput" role="form" action="<?=$__CFG_http_apps?>index.php/data/riskheader/" enctype="multipart/form-data" method="post" class="form-horizontal">
					...
					<div class="form-group">
						...
						<div class="col-md-4">
								<select name="counterpart" id="counterpart" value="<? echo $counterpart?>" class="form-control input-sm validate[required]" required="required"/>
								<option ></option>
					...
					<div class="form-group">
													   <label class="control-label col-md-3">Departemen/Divisi/Manajemen Terkait<span >*</span></label>
													
													   <div class="col-md-4">
													
														<?php
															$qry = new GCD("select * from department where statuslegal='1' order by DepartmentName");							
															?>
															
															<select multiple id="iddepartment" name="iddepartment[]" class="col-md-12 ">
															<?php foreach ($qry->listAllData("") as $val){?>
...
<!-- ------------------------------------------------------------------------------------------- -->		
					...
					<div class="form-group">
						<label class="control-label col-md-3">Keterangan *</label>
						<div class="col-md-4">
								<textarea name="keterangan" id="keterangan"  class="form-control input-sm validate[required]"  /><?echo $keterangan?></textarea>
						</div>
					</div>
					<?php }?>
												 ...
												 <div class="col-md-12">
													<div class="col-md-offset-3 col-md-9">
													 <!--  <a href="javascript:;" class="btn btn-default prevBtn">
													  ...
													  --> 
													    <button type="submit" id="submit" class="btn btn-gold">Simpan</button>   
...
<script type="text/javascript">
var urlData = '<?=$__CFG_http_apps?>index.php/data/riskheader/';
var urlSave = '<?=$__CFG_http_apps?>index.php/data/documentwizard_offline_save/?idtype=<?php  echo $_REQUEST['idtype']?>';
var urlSaveheader = '<?=$__CFG_http_apps?>index.php/data/riskheader_save/';
var urlDelete = '<?=$__CFG_http_apps?>index.php/data/riskheader_delete/';
